...
用法:
  apitester render <yaml_path> [--output <path>]
"""
import yaml, sys, os
...
def run_render(yaml_path: str, output: str = None):
    """执行渲染"""
    ...
    if not output:
        ...
        output = f"reports/{channel}/{model}_report.md"
...
def main():
    ...
    run_render(args.yaml_path, args.output)
